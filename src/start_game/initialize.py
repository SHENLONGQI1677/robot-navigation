...
def init():
    ...
    888888888888  ,ad8888ba,    888b      88    ,ad8888ba,           88  88  
         88      d8"'    `"8b   8888b     88   d8"'    `"8b          88  88  
         88     d8'        `8b  88 `8b    88  d8'                    88  88  
         88     88          88  88  `8b   88  88                     88  88  
         88     88          88  88   `8b  88  88      88888          88  88  
         88     Y8,        ,8P  88    `8b 88  Y8,        88          88  88  
         88      Y8a.    .a8P   88     `8888   Y8a.    .a88  88,   ,d88  88  
         88       `"Y8888Y"'    88      `888    `"Y88888P"    "Y8888P"   88  
                                                                           
     .oooooo..o   .oooooo.     .oooooo.      ooooo                   .o8       
    d8P'    `Y8  d8P'  `Y8b   d8P'  `Y8b     `888'                  "888       
    Y88bo.      888          888              888          .oooo.    888oooo.  
     `"Y8888o.  888          888              888         `P  )88b   d88' `88b 
         `"Y88b 888          888              888          .oP"888   888   888 
    oo     .d8P `88b    ooo  `88b    ooo      888       o d8(  888   888   888  .o. 
    8""88888P'   `Y8bood8P'   `Y8bood8P'     o888ooooood8 `Y888""8o  `Y8bod8P'  Y8P                        
    
    Cooperation with
     
     o8o  oooooooooooo ooooo       oooooo   oooo ooooooooooooo oooooooooooo oooo    oooo 
     `"'  `888'     `8 `888'        `888.   .8'  8'   888   `8 `888'     `8 `888   .8P'  
    oooo   888          888          `888. .8'        888       888          888  d8'    
    `888   888oooo8     888           `888.8'         888       888oooo8     88888[      
     888   888    "     888            `888'          888       888    "     888`88b.    
     888   888          888       o     888           888       888       o  888  `88b.  
    o888o o888o        o888ooooood8    o888o         o888o     o888ooooood8 o888o  o888o 
    """
    print(logo)
...
if __name__  == '__main__':
    try:
        ...
        md5_result2 = md5sum_dir('~/gazebo_test_ws/src/gazebo_pkg/urdf', md5_result2)
